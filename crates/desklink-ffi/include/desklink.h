...
typedef enum DesklinkKeyCode {
    DESKLINK_KEY_CHARACTER = 0,
    DESKLINK_KEY_ENTER = 1,
    DESKLINK_KEY_ESCAPE = 2,
    DESKLINK_KEY_BACKSPACE = 3,
    DESKLINK_KEY_TAB = 4,
    DESKLINK_KEY_ARROW_UP = 5,
    DESKLINK_KEY_ARROW_DOWN = 6,
    DESKLINK_KEY_ARROW_LEFT = 7,
    DESKLINK_KEY_ARROW_RIGHT = 8,
    DESKLINK_KEY_DELETE = 9,
    DESKLINK_KEY_INSERT = 10,
    DESKLINK_KEY_HOME = 11,
    DESKLINK_KEY_END = 12,
    DESKLINK_KEY_PAGE_UP = 13,
    DESKLINK_KEY_PAGE_DOWN = 14,
    DESKLINK_KEY_CAPS_LOCK = 15,
    DESKLINK_KEY_F1 = 16,
    DESKLINK_KEY_F2 = 17,
    DESKLINK_KEY_F3 = 18,
    DESKLINK_KEY_F4 = 19,
