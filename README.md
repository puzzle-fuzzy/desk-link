...
当前候选的协议、功能和发布边界以本节、[CHANGELOG.md](CHANGELOG.md) 与 [docs/current-architecture-contract.md](docs/current-architecture-contract.md) 为准；更早的开发记录只保留在 Git 历史中，不构成当前客户端或中继的兼容承诺。
