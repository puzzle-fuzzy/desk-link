...
impl Dh for Dh25519 {
    ...
    fn dh(&self, pubkey: &[u8], out: &mut [u8]) -> Result<(), Error> {
        ...
        let result = MontgomeryPoint(pubkey_owned)
            .mul_clamped(self.privkey)
            .to_bytes();
...
mod tests {
    ...
    fn test_kyber1024() {
        ...
        let (ss1_len, ct_len) = kem_2
            .encapsulate(kem_1.pubkey(), &mut shared_secret_1, &mut ciphertext)
            .unwrap();
        let ss2_len = kem_1
            .decapsulate(&mut ciphertext, &mut shared_secret_2)
            .unwrap();
    ...
    fn test_kyber1024_fail() {
        ...
        let (ss1_len, ct_len) = kem_2
            ...
            .unwrap();
        let ss2_len = kem_1
            .decapsulate(&mut bad_ciphertext, &mut shared_secret_2)
            .unwrap();
