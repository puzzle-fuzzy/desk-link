...
mod tests {
    ...
    fn test_duplicate_psk_mod() {
        assert!("Noise_XXfallback+psk1_25519_AESGCM_SHA256"
            .parse::<NoiseParams>()
            .is_ok());
        assert_eq!(
            Error::Pattern(PatternProblem::UnsupportedModifier),
            "Noise_XXfallback+fallback_25519_AESGCM_SHA256"
                .parse::<NoiseParams>()
                .unwrap_err()
        );
        assert_eq!(
            Error::Pattern(PatternProblem::UnsupportedModifier),
            "Noise_XXpsk1+psk1_25519_AESGCM_SHA256"
                .parse::<NoiseParams>()
                .unwrap_err()
        );
    }
    ...
    fn test_extraneous_string_data() {
        assert_eq!(
            Error::Pattern(PatternProblem::UnsupportedModifier),
            "Noise_XXpsk0_25519_AESGCM_SHA256_HackThePlanet"
                .parse::<NoiseParams>()
                .unwrap_err()
        );
    }
